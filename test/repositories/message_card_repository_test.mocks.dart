...
// in your_choice/test/repositories/message_card_repository_test.dart.
...
import 'package:your_choice/models/message_card.dart' as _i9;
import 'package:your_choice/services/hive/message_card_cache_service.dart'
    as _i8;
import 'package:your_choice/services/image_delete_service.dart' as _i10;
...
/// A class which mocks [MessageCardCacheService].
///
/// See the documentation for Mockito's code generation for more information.
class MockMessageCardCacheService extends _i1.Mock
    implements _i8.MessageCardCacheService {
  MockMessageCardCacheService() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i5.Future<void> saveMessageCard(
    _i9.MessageCard? messageCard,
    String? profileId,
  ) =>
      (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i9.MessageCard? getMessageCard(
  ...
  @override
  List<_i9.MessageCard> getMessageCardsByCategory(
    int? categoryId,
    String? profileId,
  ) =>
      (super.noSuchMethod(
        Invocation.method(
          #getMessageCardsByCategory,
          [
            categoryId,
            profileId,
          ],
        ),
        returnValue: <_i9.MessageCard>[],
      ) as List<_i9.MessageCard>);

  @override
  List<_i9.MessageCard> getAllMessageCards(String? profileId) =>
      (super.noSuchMethod(
        Invocation.method(
          #getAllMessageCards,
          [profileId],
  ...
  @override
  _i5.Future<void> clearCacheOfProfile(String? profileId) =>
      (super.noSuchMethod(
        Invocation.method(
          #clearCacheOfProfile,
          [profileId],
  ...
  @override
  _i5.Future<void> clearCacheAll() => (super.noSuchMethod(
        Invocation.method(
          #clearCacheAll,
          [],
        ),
  ...
  @override
  _i5.Future<void> deleteMessageCard(
    String? messageCardId,
    String? profileId,
  ) =>
      (super.noSuchMethod(
  ...
  @override
  _i5.Future<void> updateSelectionCount(
    String? messageCardId,
    String? profileId,
  ) =>
      (super.noSuchMethod(
  ...
  @override
  List<_i9.MessageCard> getTopSelectedCardsFromCache(String? profileId) =>
      (super.noSuchMethod(
        Invocation.method(
          #getTopSelectedCardsFromCache,
          [profileId],
        ),
        returnValue: <_i9.MessageCard>[],
      ) as List<_i9.MessageCard>);
  ...
  @override
  _i5.Future<void> saveImageFileLocally(
    _i9.MessageCard? messageCard,
    String? profileId,
    String? imageUrl,
  ) =>
  ...
  @override
  _i5.Future<void> updateCategoryCacheFromSnapshot(
    _i4.QuerySnapshot<Object?>? snapshot,
    String? profileId,
  ) =>
      (super.noSuchMethod(
        Invocation.method(
          #updateCategoryCacheFromSnapshot,
          [
            snapshot,
            profileId,
          ],
...
/// A class which mocks [ImageDeleteService].
///
/// See the documentation for Mockito's code generation for more information.
class MockImageDeleteService extends _i1.Mock
    implements _i10.ImageDeleteService {
  MockImageDeleteService() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i5.Future<void> deleteImageFromStorage(String? imageUrl) =>
      (super.noSuchMethod(
        Invocation.method(
